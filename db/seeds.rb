...
User.create(first_name: "Karl", last_name: "Kalla", city: "Berlin", plz: 10405,
            languages: "English, German", specialties: "Tax advice", discription: "My name is Karl . I am based in Berlin and  working as a tour guide. I’m from Berlin and love the variety of cultures in the city .
            I know how difficult it is to settle in Berlin so I decided to help fellow immigrants on my spare time.
